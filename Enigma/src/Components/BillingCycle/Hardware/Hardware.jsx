...
export default function Hardware() {
  // Simulating the active step state (1 = Hardware, 2 = Software, etc.)
  ...
  // Dynamically calculate the width percentage of the filled progress bar line
  ...
  return (
    <div className="lg:col-span-8 space-y-6">
      ...
      {/* 2. Hardware Selection Section Card */}
      <section 
        style={{ backgroundColor: '#ffffff', borderColor: '#c5c6ce' }} // surface-container-lowest, outline-variant
        className="rounded-xl overflow-hidden border shadow-sm"
      >
        {/* Card Image Header Showcase wrapper */}
        <div className="relative h-64 w-full bg-white flex items-center justify-center p-6">
          ...
          />
          {/* Hardware Badge overlay */}
          <div 
            style={{ 
              backgroundColor: 'rgba(9, 28, 53, 0.85)', // primary-container (hex code opacity adjusted)
              borderColor: '#374762' // on-primary-fixed-variant
            }}
